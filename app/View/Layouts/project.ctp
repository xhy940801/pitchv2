		...
		<div class="row">
			<div class="span3 bs-docs-sidebar hidden-phone">
				<ul class="nav nav-list bs-docs-sidenav">
					<li><a href="<?php echo MY_WEB_ROOT.'Projects/addProject'; ?>"><i class="icon-chevron-right is-selected"></i>增加项目</a></li>
					<li><a href="<?php echo MY_WEB_ROOT.'Projects/showAllProjects'; ?>"><i class="icon-chevron-right is-selected"></i>查看项目</a></li>
